...
public class p extends JApplet{
	...
	static void CreateList()  throws IOException{
		BufferedReader br=new BufferedReader(new FileReader("/home/jenit1/Desktop/9_42_43_26_63/dataset.txt"));
		String x,t;
		String temp1[],temp2[];
		int i,y=0;
		...
		br=new BufferedReader(new FileReader("/home/jenit1/Desktop/9_42_43_26_63/dataset.txt"));
		y=0;
		while((x=br.readLine())!=null){
			t="";
			temp1=x.split(" ");
